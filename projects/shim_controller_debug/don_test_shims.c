...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  /* set FPGA clock to 72 MHz */
  slcr[2] = 0xDF0D;	// SLCR_UNLOCK (0xF800008) gets unlock key; see Zynq TRM p.1576
  slcr[92] = (slcr[92] & ~0x03F03F30) | 0x00200700;  // FPGA0_CLK_CTRL (0xF800170) turns off all non-reserved bits, clk source = IO PLL, divider cascades are 7 & 1; see Zynq TRM p.699
  printf(".... Done !\n"); fflush(stdout);
